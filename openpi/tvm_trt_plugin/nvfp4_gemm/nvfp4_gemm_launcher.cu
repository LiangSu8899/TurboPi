/*
 * NVFP4_GEMM Kernel Launcher - TVM Generated
 */
...
extern "C" __global__ void __launch_bounds__(256) nvfp4_gemm_kernel(float* __restrict__ A, float* __restrict__ C, float* __restrict__ W, float* __restrict__ scale_A, float* __restrict__ scale_W);
extern "C" __global__ void __launch_bounds__(256) nvfp4_gemm_kernel(float* __restrict__ A, float* __restrict__ C, float* __restrict__ W, float* __restrict__ scale_A, float* __restrict__ scale_W) {
...
void launch_nvfp4_gemm(
    ...
    nvfp4_gemm_kernel<<<num_blocks, THREADS_PER_BLOCK, 0, stream>>>(
        const_cast<float*>(A),
        C,
        const_cast<float*>(W),
